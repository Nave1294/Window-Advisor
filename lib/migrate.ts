...
const ALTERS = [
  ...
  "ALTER TABLE rooms ADD COLUMN wall_color TEXT NOT NULL DEFAULT 'MEDIUM'",
  "ALTER TABLE rooms ADD COLUMN roof_color TEXT NOT NULL DEFAULT 'MEDIUM'",
  "ALTER TABLE rooms ADD COLUMN roof_type TEXT NOT NULL DEFAULT 'ATTIC_BUFFERED'",
