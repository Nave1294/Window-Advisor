        ...
        {!loading && rec && (
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            ...
            <div style={{
              ...
              background:hasGoodConditionsToday ? "var(--sage-light)" : "var(--bg-subtle)",
              border:`1px solid ${hasGoodConditionsToday ? "#A3E4B5" : "var(--border-mid)"}`,
            }}>
              <span style={{ fontSize:20, flexShrink:0, marginTop:2 }}>
                {hasGoodConditionsToday ? (
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="2" y="3" width="18" height="16" rx="1.5" stroke="#1A8C3A" strokeWidth="1.6" fill="none"/>
                    <line x1="2" y1="7" x2="20" y2="7" stroke="#1A8C3A" strokeWidth="1.4"/>
                    <line x1="11" y1="7" x2="11" y2="19" stroke="#1A8C3A" strokeWidth="1.4"/>
                    <line x1="4.5" y1="10" x2="8.5" y2="16.5" stroke="#1A8C3A" strokeWidth="0.9" strokeLinecap="round" opacity="0.5"/>
                    <line x1="6.5" y1="9.5" x2="9" y2="14" stroke="#1A8C3A" strokeWidth="0.9" strokeLinecap="round" opacity="0.5"/>
                  </svg>
                ) : "🔒"}
              </span>
              <div>
                ...
                {summary && (
                  <p style={{ fontSize:13, color:hasGoodConditionsToday ? "#1A8C3A" : "var(--muted)", fontWeight:500 }}>
                    {condLine}
                  </p>
                )}
              </div>
